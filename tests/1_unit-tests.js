...
suite('UnitTests', () => {
  ...
  suite('Function validate()', () => {
    ...
    test('Shows an error for puzzles that are not 81 numbers long', done => {
      ...
      assert.isFalse(solver.validate(shortStr));  
      assert.isFalse(solver.validate(longStr));
  ...
  suite('Function checkColPlacement()', () => {
    test('Valid placement for a col', done => {
      const input = '..9..5.1.85.4....2432......1...69.83.9.....6.62.71...9......1945....4.37.4.3..6..';
      const row = 0;
      const col = 0;
      const value = 3;
    ...
    test('Invalid placement for a col', done => {
      const input = '..9..5.1.85.4....2432......1...69.83.9.....6.62.71...9......1945....4.37.4.3..6..';
      const row = 0;
      const col = 0;
      const value = 9;
  ...
  suite('Function solvePuzzle()', () => {
    ...
    test('Returns the expected solution for an incomplete puzzle', done => {
      ...
      const solved = "769235418851496372432178956174569283395842761628713549283657194516924837947381625";
        assert.equal(solver.solution(input), solved);
